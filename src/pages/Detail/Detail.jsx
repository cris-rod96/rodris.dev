  ...
  return (
    <Container>
      <main className='lg:mt-0 mt-10'>
        <NavLink to='/projects' className='flex items-center gap-2 text-lg text-gray-500 hover:text-white transition-colors duration-300'>
            ...
            ? (
              <section className='flex flex-col my-5'>
                ...
                >
                  ...
                  <div className='flex lg:flex-row flex-col-reverse gap-3 justify-between lg:mt-10 mt-5 mb-5 lg:mb-0'>
                    <div className='flex flex-col justify-between lg:my-0'>
                      <h3 className='mb-2 text-xl tracking-tighter text-gray-400'>{currentProject.description}</h3>
                    ...
                    <div className='flex lg:flex-col flex-row flex-wrap justify-center gap-3 lg:w-64 tracking-tighter'>
                ...
                <div className='flex flex-col lg:mt-10'>
                  ...
                  >
                    <p className='mt-5 text-justify text-gray-400 text-xl tracking-tighter'>
                    ...
                    {currentProject.urls.some((url) => url.label === 'Code')
                      ...
                      currentProject.urls.find((url) => url.label === 'Code')
                        .url
                          ...
                          className='py-3 border border-gray-500/20 rounded-md w-full flex items-center justify-center  transition-colors duration-300 mt-5 bg-primary text-gray-200 hover:text-white hover:bg-primary/90 gap-2 text-lg'
                        >
                          <LuGithub />
                          Ver en Github
                        </NavLink>
